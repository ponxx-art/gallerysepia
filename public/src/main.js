...
instructions.innerHTML = '<div>Click to enter</div><div style="font-size:14px;margin-top:10px">WASD / Arrow keys to move<br>Mouse to look around<br>Esc to exit</div>';
